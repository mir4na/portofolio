...
const CallingCardSection = () => (
    <motion.div
        ...
        className="w-full h-full bg-[#111] relative flex items-center justify-center p-2 sm:p-3 md:p-4 overflow-hidden"
    >
        ...
        <div className="relative z-10 bg-white border-2 sm:border-4 md:border-[16px] border-black p-3 sm:p-4 md:p-16 transform rotate-1 md:rotate-2 shadow-[0_0_25px_rgba(217,0,0,0.5)] sm:shadow-[0_0_50px_rgba(217,0,0,0.5)] md:shadow-[0_0_100px_rgba(217,0,0,0.5)] max-w-4xl text-center clip-comic w-full mx-2 md:mx-4">

            <div className="absolute -top-3 sm:-top-4 md:-top-8 left-1/2 -translate-x-1/2 bg-[#d90000] text-white font-persona text-base sm:text-xl md:text-6xl px-3 sm:px-4 md:px-12 py-0.5 sm:py-1 md:py-4 border sm:border-2 md:border-[6px] border-black transform -rotate-3 shadow-[2px_2px_0_#fff] sm:shadow-[3px_3px_0_#fff] md:shadow-[10px_10px_0_#fff] whitespace-nowrap">
                CALLING CARD
            </div>

            <div className="mt-4 sm:mt-6 md:mt-12 space-y-1.5 sm:space-y-2 md:space-y-6">
            ...
            <div className="mt-3 sm:mt-4 md:mt-12 flex flex-col sm:flex-row justify-center gap-1.5 sm:gap-2 md:gap-6">
            ...
            <div className="absolute -bottom-2 -left-2 sm:-bottom-4 sm:-left-4 md:-bottom-10 md:-left-10 text-3xl sm:text-5xl md:text-[10rem] text-[#d90000] font-persona pointer-events-none opacity-50 rotate-12">
                !
            </div>
        </div>
    </motion.div>
