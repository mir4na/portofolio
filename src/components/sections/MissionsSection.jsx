                    ...
                    {selectedProject && (
                        <div className="fixed inset-0 z-[99999] flex items-center justify-center p-2 sm:p-4">
                            ...
                            >
                                ...
                                <div className="bg-[#111] border-l-[4px] sm:border-l-[6px] md:border-l-[10px] border-r-[4px] sm:border-r-[6px] md:border-r-[10px] border-white p-3 sm:p-4 md:p-12 shadow-[8px_8px_0_#d90000] sm:shadow-[15px_15px_0_#d90000] md:shadow-[25px_25px_0_#d90000] relative overflow-hidden max-h-[80vh] overflow-y-auto">
                                    ...
                                    <div className="flex flex-col md:flex-row gap-3 sm:gap-4 md:gap-8 mt-4 sm:mt-6 md:mt-2">
                                        <div className="w-full md:w-1/3">
                                            <div className="aspect-square bg-black border-2 sm:border-[3px] md:border-[5px] border-white overflow-hidden relative group transform -rotate-1 shadow-[4px_4px_0_#000] sm:shadow-[8px_8px_0_#000]">
                                        ...
                                        <div className="flex-1 text-white relative">
                                            ...
                                            <h2 className="text-xl sm:text-3xl md:text-6xl font-persona text-white text-stroke-sm mb-1 sm:mb-2 md:mb-6 leading-none transform -skew-x-3">
                                                {selectedProject.name}
                                            </h2>

                                            <div className="w-full h-1 sm:h-2 mb-2 sm:mb-4 relative overflow-hidden" style={{ clipPath: "polygon(0 0, 5% 100%, 10% 0, 15% 100%, 20% 0, 25% 100%, 30% 0, 35% 100%, 40% 0, 45% 100%, 50% 0, 55% 100%, 60% 0, 65% 100%, 70% 0, 75% 100%, 80% 0, 85% 100%, 90% 0, 95% 100%, 100% 0, 100% 100%, 0 100%)" }}>
